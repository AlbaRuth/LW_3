...
// Обновить таблицу
        ...
        Action GetInfoAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(null,"Сакович Артем, 9 группа", "Автор",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        };


        searchValueMenuItem = refMenu.add(GetInfoAction);
